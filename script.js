...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const dynamicQuotes = [
        ...
        { quote: `"If you ain't first, you're last."`, attribution: "- Ricky Bobby, Talladega Nights" },
        { quote: `"Shake and bake!"`, attribution: "- Ricky Bobby & Cal Naughton Jr., Talladega Nights" },
        { quote: `"I wanna go fast!"`, attribution: "- Ricky Bobby, Talladega Nights" },
        { quote: `"Help me Tom Cruise! Tom Cruise, use your witchcraft on me to get the fire off me!"`, attribution: "- Ricky Bobby praying for assistance" },
        { quote: `"60% of the time, it works every time."`, attribution: "- Brian Fantana, Anchorman (on betting odds?)" },
        { quote: `"If you can dodge a wrench, you can dodge a ball."`, attribution: "- Patches O'Houlihan, Dodgeball" },
        { quote: `"Everybody panic! It's just like the Titanic, but it's full of bears!"`, attribution: "- Jackie Moon, Semi-Pro (when the game plan fails)" },
        { quote: `"You're killin' me, Smalls!"`, attribution: "- Ham Porter, The Sandlot" },
        { quote: `"Heroes get remembered, but legends never die."`, attribution: "- The Babe (via Narrator), The Sandlot" },
        { quote: `"Juuuuust a bit outside."`, attribution: "- Harry Doyle, Major League" },
        { quote: `"Are you saying Jesus Christ can't hit a curveball?"`, attribution: "- Eddie Harris, Major League" },
        { quote: `"Now that's what I call high-quality H2O."`, attribution: "- Bobby Boucher, The Waterboy" },
        { quote: `"You can do it!"`, attribution: "- Various Townies, The Waterboy" },
        { quote: `"We goin' Sizzler! We goin' Sizzler!"`, attribution: "- Sidney Deane, White Men Can't Jump" },
        { quote: `"You can listen to Jimi but you can't hear him."`, attribution: "- Sidney Deane, White Men Can't Jump" },
        { quote: `"Let's get tropical!"`, attribution: "- Jackie Moon, Semi-Pro" },
        { quote: `"In the annals of history, people are gonna be talking about three things: the discovery of fire, invention of the submarine, and the Flint Michigan Mega Bowl!"`, attribution: "- Jackie Moon, Semi-Pro" },
        { quote: `"Now get out there and take your pants off!"`, attribution: "- Coach Morris Buttermaker, Bad News Bears (Advice?)" },
        { quote: `"All I know is when we win a game, it's a team win. When we lose a game, it's my fault."`, attribution: "- Coach Morris Buttermaker, Bad News Bears" },
        { quote: `"I am 'The Hammer'! Prepare to be nailed!"`, attribution: "- Richie Goodman, The Benchwarmers" },
        { quote: `"We're like the Jamaican bobsled team of baseball."`, attribution: "- Clark Reedy, The Benchwarmers" },
        { quote: `"How can you not be romantic about baseball?"`, attribution: "- Billy Beane, Moneyball" },
        { quote: `"It's a process, trust the process."`, attribution: "- Billy Beane, Moneyball (sort of)" },
        { quote: `"He gets on base."`, attribution: "- Peter Brand, Moneyball" },
        { quote: `"Our deepest fear is not that we are inadequate. Our deepest fear is that we are powerful beyond measure."`, attribution: "- Timo Cruz (quoting Marianne Williamson), Coach Carter" },
        { quote: `"Sir, they can cut the chains off the door, but they can't make us play."`, attribution: "- Jason Lyle, Coach Carter" },
